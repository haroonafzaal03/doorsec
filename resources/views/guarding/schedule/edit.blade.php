...
<div class="row p-t-10">
    <div class="col-md-12">
        <div class="">
            <form action="{{ route('guarding_update',$guarding) }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group">
                                <input type="text" readonly="" name="start_date" id="venue_start_date" class="form-control datepicker" value="{{  ($guarding) ?\Carbon\Carbon::parse($guarding->start_date)->format('m/d/Y') : '' }}" autocomplete="off">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group">
                                <input type="text" readonly="" name="end_date" id="venue_end_date" class="form-control datepicker" value="{{  ($guarding) ? $end_date =  \Carbon\Carbon::parse($guarding->end_date)->format('m/d/Y'): '' }}" autocomplete="off">
                                <div class="input-group-addon">
                                    <i class="fa fa-calendar-o"></i>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="bootstrap-timepicker row">
							...
							<div class="form-group col-md-3 col-lg-2 col-xl-3" style="padding: 0px 3px">
                                ...
                                <div class="input-group">
                                    <input type="text" name="require_staff_day" id="require_staff_day" class="form-control" value="{{$guarding->require_staff_day}}">
                                </div>
                            </div>
                            <div class="form-group col-md-3 col-lg-2 col-xl-3" style="padding: 0px 3px">
							...
							<div class="form-group col-md-3 col-lg-2 col-xl-3" style="padding: 0px 3px">
                                ...
                                <div class="input-group">
                                    <input type="text" name="require_staff_night" id="require_staff_night" class="form-control" value="{{$guarding->require_staff_night}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                <button class="btn btn-primary pull-right" id="add_shift" style="margin-top: 16px;">Add Shift</button>
                            </div>
                            @endhasrole
                        </div>
                    </div>
                            ...
                            <table class="table" id="table-venue_shifts">
                                ...
                                <tbody id="venue_shifts_tbody">
                                    ...
                                    <td style="width:22%">
                                        <div class="form-group col-md-12">
                                            <div class="input-group">
                                                <input type="text" readonly name="start_time[]" class="form-control from_time_{{$gss->shift_type}} timepicker" value="{{$gss->start_time}}" onchange="calculateStaffHours('tr_{{$key+1}}' );" />
                                                <div class="input-group-addon">
                                    ...
                                    <td style="width:22%">
                                        <div class="form-group col-md-12">
                                            <div class="input-group">
                                                <input type="text" readonly name="end_time[]" class="form-control timepicker to_time_{{$gss->shift_type}}" value="{{$gss->end_time}}" onchange="calculateStaffHours( 'tr_{{$key+1}}');">
                                                <div class="input-group-addon">
                                                    <i class="fa fa-clock-o"></i>
                                                </div>
                                            </div>
                                    ...
                                    <td class="staff_image_temp">
                                        <img src="{{img($gss->staff->picture)}}" class="img-circle user_image">
                                        <br>
                                        <small class="bold">{{$gss->staff->name??''}}</small>
                                    </td>
                ...
                <div class="col-md-3 col-lg-3 col-xl-4 vs_popup-staff-section">
                    ...
                    <div class="col-md-12 m-t-20 m-b-20">
                        <button type="submit" class="btn btn-warning pull-right" id="btnnn-edit">
                            Update</button>
                    </div>
    ...
    <script>
        ...
        function calculateStaffHours(id = '', temp1 = '') {
            ...
            $('.from_time_Day').val(day_from);
            $('.to_time_Day').val(day_to);
            $('.from_time_Night').val(night_from);
            $('.to_time_Night').val(night_to);
            if (id != '' && temp1 == '') {
        ...
        function select_shift_type(id,value){
            ...
            $('#' + id).closest('tr').find('td:nth-child(3)').find('input[name="start_time[]"]').addClass('from_time_'+addclass);
            $('#' + id).closest('tr').find('td:nth-child(3)').find('input[name="start_time[]"]').removeClass('from_time_'+removeclass);
            $('#' + id).closest('tr').find('td:nth-child(4)').find('input[name="end_time[]"]').val(to);
            $('#' + id).closest('tr').find('td:nth-child(4)').find('input[name="end_time[]"]').addClass('to_time_'+addclass);
            $('#' + id).closest('tr').find('td:nth-child(4)').find('input[name="end_time[]"]').removeClass('to_time_'+removeclass);
        }
    ...
    $('input[name="selected_staff[]"]').each(function () {
        if ($(this).val() != '') {
            runtime_selected_staff.push({
                staff: $(this).val(),
                start_time: $(this).closest('tr').find('input[name="start_time[]"]').val(),
                end_time: $(this).closest('tr').find('input[name="end_time[]"]').val()
            });
        }
    });
