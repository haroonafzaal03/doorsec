      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <form role="form" id="add_schedule_form" action="{{ route('event_store')}}" method="POST" enctype="multipart/form-data">
                @csrf
           <!--  BEGIN Form-->
            <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group" style="width: 100%;">
                      <input class="form-control" name="location" id="keyword" data-type="default" data-element="text" placeholder="Enter Venue Location" type="text" autocomplete="off" >
                    </div>
                ...
                <div class="form-group hide">
                  <label for=""></label>
                  <input type="text"  class="form-control" name="location-off" value=""/>
                </div>
            </div>
