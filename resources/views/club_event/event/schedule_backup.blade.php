    ...
    function renderSchedule(ar,columns){
        ...
        for (var e = 0; e < events.length; e++) {
            ...
            if (moment(start_date).isSame(end_date)) {
                ...
                var event_card = '<div class="event_card '+event_card_background+' '+event_card_border+'"><span class="timings"> '+event_start_time+' - '+event_end_time+'</span><br><span class="client">'+ staff +'</span><br><span class="event-name">'+events[e].event_name+'</span></div>';
