...
<section class="content">
   <div class="row">
      <div class="col-xs-12">
         <div class="box collapsed-box-off">
            <div class="box-header">
               <h3 class="box-title">Duplicate Schedule
               <span class="label m-l-20 {{ get_label_class_by_key('confirmed') }} " > Total Staff  ( {{$staff_status['total_confirmed']+$staff_status['total_pending']+$staff_status['total_dropout'] }} ) </span>
            ...
            <!-- /.box-header -->
            <div class="box-body" >
              <form role="form" id="add_schedule_form" action="{{ route('store_duplicate')}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <!--  BEGIN Form-->
                  <div class="row">
                     <div class="col-md-12">
                           ...
                           <div clas="row">
                              <div class="col-md-6 p-l-0">
                                 <div class="form-group">
                                    <input type="hidden" name="duplicate_id" value="{{$id}}">
                           ...
                           <div class="bootstrap-timepicker row">
                              ...
                              <div class="form-group col-md-6">
                                 ...
                                 <div class="input-group">
                                    <input type="text" readonly  value="{{ (!empty($schedule_data['start_date']) && ($schedule_data['start_date'] != '0000-00-00')) ? date('m/d/Y',strtotime("+1 months",strtotime($schedule_data['start_date']))) : '' }}" name="start_date" id="event_start_date" class="form-control datepicker start_date">
                              ...
                              <div class="form-group col-md-6">
                                 ...
                                 <div class="input-group">
                                    <input type="text" readonly value="{{ (!empty($schedule_data['end_date']) && ($schedule_data['end_date'] != '0000-00-00')) ?  date('m/d/Y',strtotime("+1 months",strtotime($schedule_data['end_date']))) : '' }}" name="end_date" class="form-control datepicker end_date">
                                    <div class="input-group-addon">
                                       <i class="fa fa-calendar-o"></i>
                                    </div>
                                 </div>
                        ...
                        <div class="col-md-6" >
                           <div class="bootstrap-timepicker row">
                              ...
                              <div class="form-group col-md-6">
                                 ...
                                 <div class="input-group">
                                    <input type="text" readonly value="{{$schedule_data['start_time']}}" id="event_start_time" name="start_time" class="form-control timepicker">
                                    <div class="input-group-addon">
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="input-group" style="width: 100%;">
                              <input class="form-control" name="location" id="keyword" data-type="default" data-element="text" placeholder="Enter Venue Location" type="text" autocomplete="off" value="{{$schedule_data['location']}}" >
                           </div>
               ...
               <div class="box-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4 " style="text-align: center;">
                        ...
                        <a class="btn btn-warning hide " data-toggle="modal" data-target="#SendSMSPopup" id="send_sms_btn" ><i class="fa fa-whatsapp mr-1" > </i>Send SMS </a>
-
         ...
         <!-- /.BOX -->
            ...
            <div class="box" style="display: none">
                  ...
                  <div class="box-body">
                     ...
                     <form role="form" id="add_staff_schedule_form" action="{{ route('event_staff_schedule_update',$id)}}" onSubmit="return CheckValidation();"  method="POST" >
                     <div class="row">
                        <div class="col-md-12 table-responsive" style="">
                              @csrf
                              <table id="staff_schedule_table" class="table table-bordered table-striped-off table-responsive fixed_header ">
                                 <thead class="bg-grey">
                                    <tr>
                                    <th style=""><input type="checkbox" id="" class="selectAll big_checkbox" name=""/></th>
                                 ...
                                 <tr id="row-{{$obj->staff->id}}" class="{{ ($obj->sms_status == 'not_sent') ?  'enable_sms' : 'disable_sms' }} {{ ($obj->status == 'dropout' ) ? 'row_disabled' : ''}} {{ ($obj->is_payroll_active == 1) ? 'row_payroll':'' }}">

                                 <td style=""><input type="checkbox" id="staff_checkbox-{{$obj->staff->id}}" class="staff_sch_check big_checkbox" name="" data-contact="{{ $obj->staff->contact_number }} " data-staff_id ="{{ $obj->staff_id }}" /></td>

                                 <td class="staff_image_temp" ><img src="{{img($obj->staff->picture)}}" class="img-circle user_image" /> <span class="username" > {{ $obj->staff->name }}  </span> </td>
                                 <td class="" >{{ $obj->staff->sira_id_number }}</td>
                                 <td  class="staff_contact_no td_contact_no {{ ($obj->sms_status == 'not_sent') ?  'enable_sms' : 'disable_sms' }}"  data-contact="{{ $obj->staff->contact_number }} " data-staff_id ="{{ $obj->staff_id }}"  >{{ $obj->staff->contact_number }}</td>
                                 <td class="" ><input type="" readonly onChange="calculateStaffHours({{$obj->staff->id}})" class="form-control timepicker start_time_input"  id="start_time_input-{{$obj->staff->id}}" name="array_staff[{{$index}}][start_time]" data-name="start_time" value="{{ $obj->start_time }}" data-validation='true' /></td>
                                 <td class="" ><input type="" readonly onChange="calculateStaffHours({{$obj->staff->id}})"  class="form-control timepicker end_time_input"  id="end_time_input-{{$obj->staff->id}}" name="array_staff[{{$index}}][end_time]" data-name="end_time" value="{{ $obj->end_time }}" data-validation='true'/></td>
                                 ...
                                 <td class="" ><input type="" class="form-control"  id="staff_hours-{{$obj->staff->id}}" name="array_staff[{{$index}}][hours]" data-name="hours" data-name="availability" value="{{ $hours }}" readonly data-validation='true' /></td>

                                 <td class="" >
                                 <input type="hidden" class="form-control"  id="staff_id-{{$obj->staff->id}}" name="array_staff[{{$index}}][staff_id]" value="{{ $obj->staff->id }}" data-name="staff_id"  data-validation='true' readonly />

                                 <input type="hidden" class="form-control"  id="" name="array_staff[{{$index}}][event_id]" value="{{ $obj->event_id }}" readonly />

                                 <input type="" class="form-control number_only"  id="rph-{{$obj->staff->id}}" name="array_staff[{{$index}}][rate_per_hour]" value="{{ $obj->rate_per_hour }}" data-name="rate_per_hour" data-validation='true'   {{ ($obj->availability == 0) ? 'readonly="readonly"' : '' }} />
                                 </td>
                                 <td class="" id="td_staff_status-{{$obj->staff->id}}" >
                                       <select class="form-control staff_status_select" id="staff_status-{{$obj->staff->id}}" name="array_staff[{{$index}}][status]" data-name="status" data-validation='true' onChange="CheckTotalConfirmation()">
                                 ...
                                 <td class="" >
                                       <input type="hidden" readonly value="{{ ($obj->sms_status) ? $obj->sms_status : 'not_sent' }}"  id="sms_status-{{$obj->staff->id}}" name="array_staff[{{$index}}][sms_status]" data-name="sms_status" data-validation="false" class="form-control pull-left" style="width:70%" value="" />

                                       <span class="bold label_sms_status label {{ get_label_class_by_key($obj->sms_status) }}"> {{   get_status_name_by_key ($obj->sms_status,'sms')}}   </span>

                                       @if($obj->sms_status == "not_sent")
                                          @if($obj->status != "dropout")
                                             <button type="button" data-toggle="modal" data-staff_id="{{$obj->staff->id}}" data-contact="{{ $obj->staff->contact_number }}" data-target="" data-staff_name ="{{ $obj->staff->name}}" id="sms_status_btn-{{$obj->staff->id}}" class="staff_sms_btn btn btn-sm btn-warning pull-right" id="staff_sms_btn-{{$obj->staff->id}}"  onclick="initializeSmsTrigger(this.id)" ><i class="fa fa-whatsapp"></i> </button>
                                          @endif
                                       @endif
                                 </td>

                                 <td class="">
                                    <select id="" class="form-control allow_check" data-id="{{$obj->staff->id}}"  data-validation='true' id="availability-{{$obj->staff->id}}" name="array_staff[{{$index}}][availability]">
                                       <option value="1" {{ ( ($obj->availability == 1) ) ? "selected" : ""}}> shown </option>
                                       <option value="0" {{ ( ($obj->availability == 0) ) ? "selected" : ""}} > not shown</option>
                                 </select>
                                    <label class="availability_label hide"> <input type="checkbox"  {{ ($obj->availability) ? 'checked' : 0 }} class="allow_check-off"  data-validation='off' /></label>
                                    </td>
                     ...
                     <div class="row">
                                 <div class="col-md-12">
                                    <button type="submit" value="1" name="submit_staff_schedule"  class=" {{ (sizeof($staff_schedule_details) > 0 ) ? '' : 'hide'}} btn btn-warning mt-3 ">Duplicate Staff Schedule</button>

                                    <button type="button" value="1" name="send_payroll" id="send_payroll" onClick="confirm_password('add_staff_schedule_form')"  class=" send_payroll_btn {{ ($confirmedStaff > 0 ) ? '' : 'hide'}} btn btn-success mt-3"> <i class="fa fa-money m-r-10"></i>Send Payroll</button>

                                    <button type="button" value="1" name="send_bulk_sms"  onClick="openBulkSmsPopup();"  class=" {{ ($sms_not_sent > 0 ) ? '' : ''}} btn btn-warning mt-3"> <i class="fa fa-whatsapp m-r-10"></i>Send Bulk SMS</button>
                                 </div>
                              </div>
...
<script>
      ...
      $(".selectAll").change(function(){
         ...
         var staffList = $('#staffList_new').html();
               ...
               onAfterRender: function (listbox) {
                 // console.log(listbox);
                  ...
                  //Code should be here
                        ...
                        var html = '';
                        [].forEach.call( document.querySelectorAll('ul#staffList_new li.selected'), function(item) { return html += '<li>'+item.innerHTML+'</li>'; })
                        console.log(html);
            ...
            $('#staffList_new').jqListbox('transferSelectedTo', $('#staffList_filled'));
               ...
               var bulk_checkbox = '<input type="checkbox" id="staff_checkbox-'+data_staffid+'" class="staff_sch_check big_checkbox" name="" data-contact="'+data_contact+'" data-staff_id="'+data_staffid+'" autocomplete="off">';
               ...
               var  staff_status_opt = '<select id="staff_status-'+data_staffid+'" class="form-control staff_status_select" onClick="changeSmsStatus(this.id);" name="array_staff['+row_no+'][status]"  data-name="status"  data-validation="true" onChange="CheckTotalConfirmation()">';
               ...
               sms_status_opt = '<input type="hidden" readonly   value="'+data_sms_status+'" class="fff form-control pull-left"  id="sms_status-'+data_staffid+'" name="array_staff['+row_no+'][sms_status]"  data-name="sms_status"  data-validation="false"  style="width:70%" /> ';
               ...
               sms_status_opt += '<span class="bold label_sms_status label '+bg_class+'">'+label_sms_status+'   </span>';

               if(data_sms_status == "not_sent")
               {
                  sms_status_opt += '<button type="button" data-toggle="modal" data-target="" data-staff_id="'+data_staffid+'"  data-contact="'+data_contact+'" data-staff_name="'+text+'" id="sms_status_btn-'+data_staffid+'" class="staff_sms_btn btn btn-sm btn-warning pull-right"  onclick="initializeSmsTrigger(this.id)"  ><i class="fa fa-whatsapp"></i> </button>';
               }

               var enable_disable_check =  (data_sms_status == 'not_sent') ? 'enable_sms' : 'disable_sms';
               ...
               var rph_field = "";
                  rph_field = '<input class="form-control number_only rate_per_hour"  value="'+data_rph+'" data-validation="true"  id="rph-'+data_staffid+'"  data-name="rate_per_hour"  name="array_staff['+row_no+'][rate_per_hour]"  '+rph_readonly_check+' />';

               var availability_label = '<select id="" class="form-control allow_check" data-id="'+data_staffid+'"  data-validation="true" data-name="availability"  id="availability-'+data_staffid+'" name="array_staff['+row_no+'][availability]">';
               availability_label +=   '<option value="1"  '+allow_pay_selected+'> shown </option>';
               availability_label += '<option value="0"  '+allow_pay_selected+'> not shown</option>';
               availability_label += '</select>';


               var availability_label_off = '<label class="availability_label hide"> <input type="checkbox" '+availability_check+' data-id="'+data_staffid+'" id="availability-'+data_staffid+'" name="array_staff['+row_no+'][availability]"   data-validation="true" class="allow_check" /></label> ';

               $("#staff_schedule_table tbody").append('<tr id="row-'+data_staffid+'" class="'+enable_disable_check+' '+row_enable_disable+' " ><td>'+bulk_checkbox+'</td><td class="staff_image_temp"><img src="'+data_image+'" class="staff_list_view img-circle user_image"/> <span class="list_staff_name" >'+text+'</span><input type ="hidden" value="{{$schedule_data->id}}"name="array_staff['+row_no+'][event_id]"  readonly /><input type ="hidden" value="'+data_staffid+'"name="array_staff['+row_no+'][staff_id]" id="staff_id-'+data_staffid+'" data-name="staff_id"   data-validation="true"  readonly /></td><td><span>'+data_sira+'<span></td><td class="staff_contact_no td_contact_no '+enable_disable_check+'" ><span >'+data_contact+'</span></td><td><input class="form-control timepicker start_time_input"  type="" readonly id="start_time_input-'+data_staffid+'"  name="array_staff['+row_no+'][start_time]" data-name="start_time" data-validation="true"  value="'+data_start_time+'" onChange="calculateStaffHours(\''+data_staffid+'\')" /></td><td><input class="form-control timepicker end_time_input" type="" readonly id="end_time_input-'+data_staffid+'" name="array_staff['+row_no+'][end_time]"  data-name="end_time"  data-validation="true"   value="'+data_end_time+'"   onChange="calculateStaffHours(\''+data_staffid+'\')" /></td><td><input class="form-control " type="" id="staff_hours-'+data_staffid+'"  value="'+data_hours+'" data-validation="true" name="array_staff['+row_no+'][hours]" data-name="hours"  readonly /></td><td>  '+ rph_field +'   </td><td id="staff_status_td">'+staff_status_opt+'</td><td >'+sms_status_opt+'</td><td>  '+ availability_label +'   </td></tr>')
  ...
  // }
   ...
   function initializeSmsTrigger(btnID)
   {
         ...
         $('form#send_sms_form .send_sms_submit').attr('onClick','sentWhatsappMsg("'+''+'","'+data_contact+'")');
         $("#SendSMSPopup").modal();
   }
   ...
   function updateStaffScheduleJson(staff_id,ph_number,MessageId,data_staff_id)
   {
	...
	var event_start_date 	= $('#event_start_date').val();
      ...
      $("tr#row-"+staff_id+" td input[data-validation='true'] , tr#row-"+staff_id+" td select[data-validation='true']").each(function(ev){
         if($(this).attr('id') != "")
         {
      ...
      var myJsonData = {formData: formData , data_staff_id: data_staff_id, event_id : event_id, phone_number : ph_number, MessageId : MessageId , is_bulk_sms : 0, event_arrving_time : event_arrving_time, event_loc_guide : event_loc_guide, event_dress_code : event_dress_code, event_location_fil : event_location_fil, event_start_time : event_start_time, event_start_date : event_start_date, event_briefing : event_briefing, event_date : event_date};
   ...
   function sentWhatsappMsg(data_staff_id,data_contact){
      ...
      iziToast.show({
			    ...
			    "messages":[
			       {
			          ...
			          "channel": "whatsapp",
			          "hsm" : {
			             "template":"event_confirmation_template",
			             "parameters" : {
                "1": "{{ isset($schedule_data)?$schedule_data['location']:'' }}",
                "2": event_loc_guideReq,
                "3": "{{ isset($schedule_data)?$schedule_data['start_date']:'' }}",
                "4": event_arr_timeReq,
                "5": eventBrie_timeReq,
        		"6": "{{ isset($schedule_data)?$schedule_data['start_date'].'-'. $schedule_data['start_time'] :'' }}",
                "7":"{{ isset($schedule_data)?$schedule_data['location']:'' }}",
                "8": event_loc_guideReq,
                "9": event_dress_codeReq
			             }
			          }
			       }
			    ]
		...
		xhr.onreadystatechange = function(){
		    if (xhr.readyState == 4 && xhr.status == 202) {
		        ...
		        SendSmstoStaff(ph_number,MessageId,data_staff_id);
   ...
   function SendBulkSms()
   {
		...
		$('.staff_sch_check:checked:checked').each(function(){
			...
			var data_staff_id = $(this).attr('data-staff_id');
			var data_contact  = $(this).attr('data-contact');
			// obj.push({"id":id});
			// alert(data_staff_id);
			// alert(data_staff_id);
			// alert(data_staff_id);return;
			//here we will pass number
			// SendSmstoStaff('923458012482','008306b40ab74edca153734b5d961eb9',data_staff_id);
			var event_arr_timeReq 		= $('form#send_sms_form input[name="arrving_time"]').val();
			var eventBrie_timeReq		= $('form#send_sms_form input[name="briefing_time"]').val();
			var event_loc_guideReq		= $('form#send_sms_form input[name="event_loc_guide"]').val();
			var event_dress_codeReq		= $('form#send_sms_form textarea[name="event_dress_code"]').val();
			sentWhatsappMsg(data_staff_id,data_contact);
			// var ph_number = "923458012482";
			// var MessageId = "2734hdhdfu32re";
			// alert(data_staff_id);
			// SendSmstoStaff(ph_number,MessageId,data_staff_id);

	//will validation here from notepad file which i just saved
		});
			return;

      $("tr input,tr select").attr('disabled','disabled'); // To disable all input  of SMS status = pending
      $("input.staff_sch_check:checked").parent('td').parent('tr').find('input').removeAttr('disabled'); // To disable all input  of SMS status = pending
      $("input.staff_sch_check:checked").parent('td').parent('tr').find('select').removeAttr('disabled'); // To disable all input  of SMS status = pending

      $("tr input[data-name='sms_status']").val('pending');
      $("form#add_staff_schedule_form").submit();
     ...
     return false;
      ...
      var myJsonData = {formData: formData , event_id : event_id , is_bulk_sms : 1};
