                ...
                <div class="row">
                    <div class="form-group col-md-2">
                        <div class="input-group date">
                            ...
                            <input type="text" readonly class="form-control pull-right" id="datepicker">
                        </div>
                        <!-- /.input group -->
                    </div>
...
<div class="row">
    ...
    <div class="col-md-2 col-sm-6 col-xs-12 info-box-common">
    <div class="info-box custom">
            <span class="info-box-icon bg-green"><i class="ion ion-ios-home"></i></span>

            <div class="info-box-content">
                <span class="info-box-text">Accoutns</span>
    ...
    <div class="info-box custom">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Employess</span>
...
<div class="row">
    <div class="col-md-8">
        <h3 class="heading bold m-t-10 text-center">{{ date("M,Y") }}</h3>
    </div>
    ...
    for(var n=0;n <= $('tr').length;n++)
    {
        ...
        $(function () {
            ...
            for (var j = 0; j < rows; j++) {
                var newRow = $('<tr>');
                var cols = "";
                cols += '<td class="headcol">' + clients[j].property_name + '</td>';
                newRow.append(cols);
                for (var k = 1; k <= columns; k++) {
                    var cols = "";
                    cols += '<td id="' + clients[j].id + '-' + ar[k - 1] + '"></td>';
                    newRow.append(cols);
                }
            ...
            for (var e = 0; e < events.length; e++) {
                ...
                if (moment(start_date).isSame(end_date)) {
                    ...
                    var td_id = client_id + '-' + start_date.format('D-ddd-YYYY');
                    var event_card = '<div class="event_card"><span class="timings"> '+event_start_time+' - '+event_end_time+'</span><br><span class="client">'+events[e].property_name+'</span><br><span class="event-name">'+events[e].event_name+'</span></div>';
                    ...
                    for (var d = 0; d < dates_array.length; d++) {
                        ...
                        var td_id = client_id + '-' + dates_array[d];
                        var event_card = '<div class="event_card"><span class="timings">'+event_start_time+' - '+event_end_time+'</span><br><span class="client">'+events[e].property_name+'</span><br><span class="event-name">'+events[e].event_name+'</span></div>';
                        $('#' + td_id).append(event_card);
                    }
                }
