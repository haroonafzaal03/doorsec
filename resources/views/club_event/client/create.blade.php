...
@section('content')
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{route('client_create')}}">Add client</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <form role="form" id="add_client_form" action="{{ route('client_store')}}" method="POST" enctype="multipart/form-data">
                @csrf
            <!-- BEGIN Form -->
            <div class="row">
              <div class="col-md-6">
                  ...
                  <div class="row">
                      ...
                      <label for=""  class="">Select Client Type</label>
                        ...
                        <div class="form-group  col-md-6 mb-2">
                            ...
                            <input type="text" class="form-control" id="property_name"  name="property_name" placeholder="Property Name" autocomplete="off"/>
                        </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="property_lice_name" name="property_lice_name" placeholder="" autocomplete="off"/>
                  </div>
                  <div class="form-group">
                    <label for="tarde_lice">Trade License Attachment</label>
                    <input type="file" class=" form-control upload" id="tarde_lice" name="tarde_lice"/>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Trade License Expiry Date</label>
                    <input type="text" readonly  class="form-control datepicker" id="property_lice_expiry_date" name="property_lice_expiry_date" placeholder="" autocomplete="off"/>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Trade License Number</label>
                    <input type="" class="form-control" id="property_lice_number" name="property_lice_number" placeholder="" autocomplete="" />
                  </div>
                  <div class="form-group">
                    <label for="property_tax_regis_num">Tax Registration Number</label>
                    <input type="" class="form-control" id="property_tax_regis_num" name="property_tax_regis_num" placeholder="" autocomplete="off"/>
                  </div>
                  <div class="form-group">
                    <label for="venue_manager_name">Venue Manager Name</label>
                    <input type="text" class="form-control" name="venue_manager_name" id="venue_manager_name" placeholder="" autocomplete="off">
                  </div>
               ...
               <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <input type="" class="form-control" id="venue_manager_number" name="venue_manager_number" placeholder="" autocomplete="off">
                  </div>
                  <div class="form-group">
                    <label for="venue_manager_email">Venue manager's Email ID</label>
                    <input type="email" id="venue_manager_email" name="venue_manager_email" class="form-control"  placeholder="" autocomplete="off">
                  </div>
                  <div class="form-group">
                    <label for="property_signatory_id">Signatory's ID Attachment</label>
                    <input type="file" class="upload form-control" name="property_signatory_id" id="property_signatory_id"/>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-md-6">
                      <input type="text" readonly  name="property_contract_start" id="property_contract_start" class="form-control datepicker"  placeholder="" autocomplete="off">
                    </div>
                    <div class="col-md-6">
                      <input type="text" readonly  id="property_contract_end" name="property_contract_end" class="form-control datepicker"  placeholder="" autocomplete="off">
                    </div>
                  </div>

                  <div class="form-group">
                    <label for="account_manager_name">Accounts Manager's Name</label>
                    <input type="text" id="account_manager_name" name="account_manager_name" class="form-control"  placeholder="" autocomplete="off">
                  </div>
                  <div class="form-group">
                    <label for="account_manager_email">Accounts manager's Email ID</label>
                    <input type="email" id="account_manager_email" name="account_manager_email" class="form-control"  placeholder="" autocomplete="off">
                  </div>

                  <div class="form-group">
                    <label for="account_manager_num">Accounts manager's Number</label>
                    <input type="" id="account_manager_num" name="account_manager_num" class="form-control"  placeholder="">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group" style="width: 100%;">
                      <input class="form-control" name="client_address" id="keyword" data-type="default" data-element="text" placeholder="Enter Venue Location" type="text" autocomplete="off" >
                    </div>
...
<script>
  $(function () {
    ...
    $('#add_client_form').bootstrapValidator({
                //        live: 'disabled',
        ...
        fields: {
          client_type_id: {
            ...
            client_address: {
                validators: {
                  notEmpty: {
                        message: 'Venue Address Required'
                    }
                }
            }
